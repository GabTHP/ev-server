...
export default class TransactionRouter {
  ...
  public buildRoutes(): express.Router {
    ...
    this.buildRouteTransactionsExportPDF();
  ...
  private buildRouteTransactionsExportPDF(): void {
    this.router.get(`/${RESTServerRoute.REST_TRANSACTIONS_EXPORT_PDF}`, (req: Request, res: Response, next: NextFunction) => {
      void RouterUtils.handleRestServerAction(TransactionService.handleExportPdfTransactions.bind(this), ServerAction.TRANSACTIONS_EXPORT_PDF, req, res, next);
    });
  }
